...
export const WORKS: Work[] = [
  ...
  },
  {
    ...
    index: "03",
    title: "Perficient",
    subtitle: "Enterprise AI, Data, Automation & B2B Technology",
    role: "Associate Technical Consultant",
    date: "Jun 2023 → Oct 2024",
    category: "Enterprise AI & Digital Products",
    lede: "Sixteen months working across AI, ML, automation and B2B digital products for enterprise clients. Sitting between business requirements and technical implementation.",
    points: [
      "Core GenAI Platform: RAG pipelines, 10K+ daily queries, <2s latency, 99.9% uptime",
...
export const CASE_STUDIES: Record<string, CaseStudy> = {
  ...
  perficient: {
    ...
    title: "Perficient",
    role: "Associate Technical Consultant",
    context: "Perficient · Enterprise AI, Data & B2B Products",
    year: "Jun 2023 → Oct 2024",
    situation:
      "Sixteen months working across AI, ML, automation and B2B digital products for enterprise clients.",
    whyItMattered:
      "Enterprise clients required production systems that integrated seamlessly with legacy stacks, met strict reliability standards, and operated without failure under heavy real-world load.",
    what:
      "I sat between business requirements and technical implementation across four key client contexts: Core GenAI Platform, Caterpillar, Aristocrat, and NorthShore Care Supply.",
    approach: [
      { step: "Core GenAI", body: "RAG pipelines serving LLM assistants across teams with 10K+ daily queries, <2s latency, and 99.9% uptime." },
      { step: "Caterpillar", body: "Enterprise knowledge retrieval making technical operational documentation retrievable in the flow of work." },
      { step: "Aristocrat", body: "Google Document AI invoice automation removing 80%+ manual data entry and saving 1,200+ staff hours/month." },
      { step: "NorthShore", body: "B2B eCommerce experience reengineering across product discovery, purchasing, checkout, and Stripe payments." },
    ],
    decision: {
      statement: "Prioritised hybrid dense + sparse retrieval, automated confidence validation, and friction-free payment workflows over fragile custom architectures.",
      why: "Enterprise systems require grounded accuracy, measurable time savings, and transaction reliability.",
    },
    tradeoff:
    ...
    outcome: [
      ...
      { value: "80%+", label: "manual entry cut" },
    ],
    lesson: "Production enterprise systems succeed on retrieval quality, operational throughput, and reliability.",
    nextId: "magpie",
