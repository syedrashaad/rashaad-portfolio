...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="shell relative grid min-h-[calc(100svh-9rem)] items-center gap-4 md:grid-cols-[1.15fr_0.85fr] md:gap-2">
        {/* ——— type column ——— */}
        <motion.div
        ...
        <div className="relative order-1 flex justify-center md:order-1 md:mr-[8%] md:justify-end lg:mr-[12%]">
          <motion.span
            aria-hidden
            style={{ x: ghostX }}
            initial={{ opacity: 0 }}
