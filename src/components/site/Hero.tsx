...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="shell relative grid min-h-[calc(100svh-9rem)] items-center gap-4 md:grid-cols-[1.25fr_0.75fr] md:gap-2">
        {/* ——— type column ——— */}
        <motion.div
        ...
        <div className="relative order-1 flex justify-center md:order-1 md:mr-[14%] md:justify-end lg:mr-[20%]">
          <motion.span
            aria-hidden
            style={{ x: ghostX }}
            initial={{ opacity: 0 }}
